...
<title><?php echo $site_title; ?> - Annonce en attente</title>
...
<h2 class="product-title">Annonce en attente</h2>
<ol class="breadcrumb">
<li><a href="../">Accueil /</a></li>
<li class="current" style="color:white">Annonce en attente</li>
</ol>
</div>
</div>
</div>
...
<li>
<a href="my-pending-ads"class="active">
