...
<title><?php echo $site_title; ?> - Annonce</title>
...
<h2 class="product-title">Annonce</h2>
<ol class="breadcrumb">
<li><a href="../">Accueil /</a></li>
<li class="current" style="color:white">Annonce</li>
</ol>
</div>
</div>
</div>
...
<h2 class="dashbord-title">Annonce en attente</h2>
</div>
...
<a onclick = "return confirm('Confirmer la supression ?'); " class="btn-action btn-delete" href="app/drop-ad.php?node=<?php echo base64_encode($row['ad_id']); ?>"><i class="lni-trash"></i></a>
</div>
</td>
</tr>
