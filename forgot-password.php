...
<p>Veuillez saisir votre adresse email ou nom d'utilisateur associé à votre compte, un lien de réinitialisation du mot de passe vous sera envoyé par email</p><br>
<div class="form-group">
<div class="input-icon">
<i class="lni-user"></i>
<input type="text" class="form-control" name="user" required placeholder="Adresse email ou pseudo">
...
<div class="g-recaptcha" data-sitekey="6LeCVGcbAAAAAMqOy5uiz7s0YGEBoMEoUiy3LcmK" style="margin: 0 auto; width: 304px;"></div>
</div>

<div class="text-center">
<a class="forgetpassword" href="login">Retour à l'écran de connexion</a><br><br>
<input id="btnSubmit" type="submit" value="Trouver un compte" class="btn btn-common log-btn">
</div>
</form>
</div>
</div>
