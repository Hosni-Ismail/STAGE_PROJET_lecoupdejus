...
<a href="ad/<?php echo $row['ad_id']; ?>"><img class="img-fluid image image-resize" src="<?php echo $firstFile; ?>" alt=""></a>
</figure>
...
<a style="font-size:18px;"href="ad/<?php echo $row['ad_id']; ?>" class="btn btn-common float-right">Voir</a>
</div>
</div>
</div>
</div>
