...
<h2 class="product-title">Accéder à votre compte</h2>
<ol class="breadcrumb">
<li><a href="./">Accueil /</a></li>
<li style="color:white;" class="current">Connexion</li>
</ol>
</div>
</div>
</div>
...
<input type="text" id="UserEmail" class="form-control" name="user_email" required placeholder="Adresse mail">
...
<a class="forgetpassword" href="forgot-password">Mot de passe oublié ?</a><br><br>
<input id="btnSubmit" type="submit" value="Connexion" class="btn btn-common log-btn">
</div>
</form>
</div>
</div>
