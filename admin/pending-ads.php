...
<head>
    ...
    <title><?php echo $site_title; ?> - Annonces en Attente</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
            <h4 class="page-header">Annonce en Attente</h4>
        </div>
            </div>
                                             ...
                                             <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a target="_blank" href="../ad/<?php echo $row['ad_id'];?>">Voir l'annonce</a>
                                                        <?php
                                                        if ($status == "active") { 
                                               ?> <li><a href="app/make-inact.php?url=pending-ads&node=<?php echo $row['ad_id'];?>">Masquer</a><?php
                                                        }else{
                                               ?> <li><a href="app/make-act.php?url=pending-ads&node=<?php echo $row['ad_id'];?>">Mettre en ligne</a><?php
                                                        }
                                                        ...
                                                        ?>
                                                         ...
                                                         <?php
                                                        if ($featured == "yes") { 
                                               ?> <li><a href="app/remov-feat.php?url=pending-ads&node=<?php echo $row['ad_id'];?>">Ne plus mettre en vedette</a><?php
                                                        }else{
                                               ?> <li><a href="app/make-feat.php?url=pending-ads&node=<?php echo $row['ad_id'];?>">Mettre en vedette</a><?php
                                                        }

                                                        ?>
                                                        <li><a onclick = "return confirm('Delete Ad ?');" href="app/drp-ad.php?url=pending-ads&node=<?php echo $row['ad_id'];?>">Supprimer</a>
                                                    </li>
