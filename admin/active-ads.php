...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
            <h4 class="page-header">Annonces en ligne</h4>
        </div>
            </div>
                                             ...
                                             <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a target="_blank" href="../ad/<?php echo $row['ad_id'];?>">Voir l'annonce</a>
                                                        <?php
                                                        if ($status == "active") { 
                                               ?> <li><a href="app/make-inact.php?url=active-ads&node=<?php echo $row['ad_id'];?>">Masquer</a><?php
                                                        }else{
                                               ?> <li><a href="app/make-act.php?url=active-adsp&node=<?php echo $row['ad_id'];?>">Mettre en ligne</a><?php
                                                        }
                                                        ...
                                                        ?>
                                                         ...
                                                         <?php
                                                        if ($featured == "yes") { 
                                               ?> <li><a href="app/remov-feat.php?url=active-ads&node=<?php echo $row['ad_id'];?>">Retirer des annonces vedettes</a><?php
                                                        }else{
                                               ?> <li><a href="app/make-feat.php?url=active-ads&node=<?php echo $row['ad_id'];?>">Ajouter aux annonces vedettes</a><?php
                                                        }

                                                        ?>
                                                        <li><a onclick = "return confirm('Supprimer cette annonce ?');" href="app/drp-ad.php?url=active-ads&node=<?php echo $row['ad_id'];?>">Supprimer</a>
                                                    </li>
